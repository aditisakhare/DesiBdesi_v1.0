...
<div class="row pad-botm">
    <div class="col-md-12">
        <h4 class="header-line">Participate in Orders</h4>
...
$shg_id = $_SESSION['shg_id'];
$adv_id = $_GET['adv_id'];
$quantity = $_GET['qty'];
$shg_district_id = $_SESSION['shg_district_id'];
...
if (mysqli_num_rows($res_check) > 0) {
    //ALREADY SUBMITTED TENDER FOR THIS ADVERTISE.
    echo "<div class='container'>You have already participated in this order.</div>";
    echo "<script>document.getElementById('form_div').style.display = 'none';</script>";
    //CAN PUT FUNCTIONALITY TO EDIT TABLE HERE
} else {
    echo '<body>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <form role="form" name="capacity_form" action="" method="post">
                        ...
                        <input type="submit" class="btn btn-success" name="submit_capacity" id="submit_capacity">
...
';
    if (isset($_POST['submit_capacity'])) {
        ...
        echo "<script>window.location='shg_homepage.php';</script>";
