...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo htmlspecialchars($path);?>css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo htmlspecialchars($path);?>css/1-col-portfolio.css" rel="stylesheet">
