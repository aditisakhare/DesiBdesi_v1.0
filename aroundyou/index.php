...
?>
<center><h3> Around You </h3></center>
...
--> 
<div class="panel-heading">
    <center><h3> Statistics about SSEs </h3></center>
 </div>       
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>SSEs Formations and Promotions <small> in Raigad </small></h2>
                      <br><br>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Top Rated SSEs <small> in Raigad</small></h2>
                    <br><br>
                      <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><label>Select District :</label><i class="fa fa-wrench"></i></a>
          ...
          <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Orders Completed <small> in Raigad </small></h2>
                    <br><br>
                      <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><label>Select District :</label><i class="fa fa-wrench"></i></a>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Products manufactured by SSEs <small> in Raigad </small></h2>
                    <br><br>
                     <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><label>Select District :</label><i class="fa fa-wrench"></i></a>
    ...
    <div class="panel-heading">
    <center><h3> SSEs Productions near your Area </h3></center>
 </div>  
